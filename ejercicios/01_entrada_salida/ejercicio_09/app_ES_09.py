...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        sueldo_flo = float(self.txt_sueldo.get())
        incremento_flo = float(self.txt_incremento.get())

        resultado = sueldo_flo * (incremento_flo / 100)
        resultado_final = resultado + sueldo_flo
